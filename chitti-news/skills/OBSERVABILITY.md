...
UptimeRobot pings `https://chitti-news-api.onrender.com/health` every **5 minutes**. A `200 {"ok": true}` is required; anything else pages Bryan. Same SLO as the Shares / MedUPI backends.
