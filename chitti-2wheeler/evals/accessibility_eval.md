...
A bike breaks down for blind, deaf, mute and illiterate riders too — Chitti serves
...
| Case | Must hold |
|---|---|
| Blind rider, "engine se awaaz aa rahi" | sound-first flow; verdict + DIY tier + cost spoken in full; safety call spoken first |
| Deaf rider, 🔴 DO-NOT-RIDE verdict | hazard shown as 🔴 symbol **+ word** + ISL + screen flash — never colour alone |
| Mute rider on the roadside | photo of dashboard light + tap answers; SOS confirm via tap button |
| Illiterate rider, breakdown | picture decision tree, spoken step-by-step, "say HAAN to call family" |
...
"accessibility asterisk." A safety verdict that a deaf rider can't perceive, or a
