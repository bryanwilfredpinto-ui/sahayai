...
Chitti Car Doctor does not ship on vibes. Every release runs the eval suite below and
must clear all five quality layers. A miss on any **safety** layer is RED and blocks
ship — full stop.

## The 5 quality layers
| # | Layer | Gate | Eval |
|---|---|---|---|
| 1 | **Technical accuracy** — right fault for the symptoms / DTC | ≥ **90%** | [diagnostic_accuracy.md](diagnostic_accuracy.md) |
...
| Dead battery / alternator / charging | 130 | verification-loop ground truth |
| DTC interpretation (P-codes) | 120 | real OBD2 logs + workshop confirmation |
| Misfire / engine noise / overheat | 110 | sound + repair confirmation |
| Diesel-specific (DPF / EGR / turbo) | 80 | diesel workshop outcomes |
| Brakes / steering / airbag / tyre (safety) | 150 | every case = a safety red-line check |
| EV (Tata EV — SoH / range / regen / HV) | 60 | EV OEM + community |
| Cost / quote-check | 100 | community fair-price + real invoices |
| Adversarial (fake code/model/part) | 100 | hand-authored traps |
