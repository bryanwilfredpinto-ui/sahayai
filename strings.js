...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "set.battery.title":"Chitti Battery","set.battery.queries":"queries left","set.battery.days":"Est. {{n}} days","set.demo":"Demo","err.network":"Chitti could not hear. Try once more.","err.retry":"Try again",
    },
    hi: {
      ...
      "hdr.howto":"कैसे उपयोग करें","hdr.gp":"बुज़ुर्ग मोड","hdr.settings":"सेटिंग्स","set.battery.title":"Chitti बैटरी","set.battery.queries":"सवाल बाकी","set.battery.days":"~{{n}} दिन","set.demo":"डेमो","err.network":"Chitti sun nahi payi — dobara bolein","err.retry":"फिर बोलें",
    },
    bn: {
      ...
      "hdr.howto":"কীভাবে ব্যবহার","hdr.gp":"বয়স্ক মোড","hdr.settings":"সেটিংস","set.battery.title":"Chitti ব্যাটারি","set.battery.queries":"প্রশ্ন বাকি","set.battery.days":"~{{n}} দিন","set.demo":"ডেমো","err.network":"Chitti shunte parlo na — abar bolun","err.retry":"আবার বলুন",
    },
    ta: {
    ...
    te: {
      ...
      "hdr.howto":"ఎలా వాడాలి","hdr.gp":"వృద్ధుల మోడ్","hdr.settings":"సెట్టింగ్స్","set.battery.title":"Chitti బ్యాటరీ","set.battery.queries":"ప్రశ్నలు మిగిలి","set.battery.days":"~{{n}} రోజులు","set.demo":"డెమో","err.network":"Chitti vinipinchaledu — malli cheppandi","err.retry":"మళ్ళీ చెప్పండి",
    },
    mr: {
