...
(function () {
  ...
  const STRINGS = {
    ...
    ta: {
      ...
      "hdr.howto":"எப்படி பயன்படுத்த","hdr.gp":"மூத்தோர் முறை","hdr.settings":"அமைப்புகள்","set.battery.title":"Chitti பேட்டரி","set.battery.queries":"கேள்விகள் மீதம்","set.battery.days":"~{{n}} நாட்கள்","set.demo":"டெமோ","vai.hero.title":"Chitti யுடன் பேசு","vai.hero.cta":"பேச தொடவும்.","vai.hero.hint":"Chitti உங்கள் மொழியில் பதிலளிக்கும்.","vai.mode.ask":"எதையும் கேள்","vai-hero-sub":"பச்சை மைக்கை தொடவும்। உங்கள் மொழியில் பேசவும்.","fb.title":"Chitti — Feedback","fb.tag":"உங்கள் feedback Chitti-யை மேம்படுத்தும்","fb.back":"பின்","fb.q":"என்ன நடந்தது? சொல்லுங்கள்","fb.mic.label":"🎙️ பேசி சொல்லுங்கள் அல்லது கீழே எழுதுங்கள்","fb.text.ph":"இங்கே எழுதுங்கள் — அல்லது மேல் பச்சை மைக் தொடவும். Chitti படித்து அனுப்பும்.","fb.readback.who":"Chitti கேட்கிறது","fb.no":"மாற்று","fb.yes":"ஆம் — அனுப்பு","fb.read":"படித்து கேட்பி","fb.submit":"அனுப்பு","fb.thanks":"நன்றி — feedback கிடைத்தது","fb.thanks.sub":"உங்கள் கருத்து Chitti-யின் founder-க்கு சென்றுவிட்டது.","na.cat.khabar":"AI செய்தி","na.cat.certs":"சான்றிதழ்","na.cat.topics":"பயிற்சி தலைப்புகள்","na.cat.tools":"Tools","na.cat.bharat":"பாரத AI","ui.suno":"கேள்","ui.mool":"மூல செய்தி படி →","err.network":"Chitti kekka mudiyala — meendum sollunga","err.retry":"மீண்டும் சொல்",
    },
    te: {
    ...
    mr: {
      ...
      "hdr.howto":"कसे वापरायचे","hdr.gp":"ज्येष्ठ मोड","hdr.settings":"सेटिंग्ज","set.battery.title":"Chitti बॅटरी","set.battery.queries":"प्रश्न शिल्लक","set.battery.days":"~{{n}} दिवस","set.demo":"डेमो","vai.hero.title":"Chitti शी बोला","vai.hero.cta":"बोलण्यासाठी टॅप करा.","vai.hero.hint":"Chitti तुमच्या भाषेत उत्तर देईल.","vai.mode.ask":"काहीही विचारा","vai-hero-sub":"हिरवा माइक टॅप करा.","fb.title":"Chitti — Feedback","fb.tag":"तुमचा feedback Chitti ला अधिक चांगलं बनवतो","fb.back":"परत","fb.q":"काय झालं? सांगा","fb.mic.label":"🎙️ बोलून सांगा किंवा खाली लिहा","fb.text.ph":"इथे लिहा — किंवा वर हिरवा माइक दाबा.","fb.readback.who":"Chitti विचारते","fb.no":"बदला","fb.yes":"होय — पाठवा","fb.read":"वाचून सांगा","fb.submit":"पाठवा","fb.thanks":"धन्यवाद — feedback मिळाला","fb.thanks.sub":"तुमचा संदेश Chitti च्या founder कडे पोहोचला.","na.cat.khabar":"AI बातमी","na.cat.certs":"प्रमाणपत्र","na.cat.topics":"प्रशिक्षण विषय","na.cat.tools":"Tools","na.cat.bharat":"भारत AI","ui.suno":"ऐका","ui.mool":"मूळ बातमी वाचा →","err.network":"Chitti aikalech naahi — punha bola","err.retry":"पुन्हा बोला",
    },
    gu: {
      ...
      "hdr.howto":"કેવી રીતે વાપરવું","hdr.gp":"વૃદ્ધ મોડ","hdr.settings":"સેટિંગ્સ","set.battery.title":"Chitti બેટરી","set.battery.queries":"પ્રશ્નો બાકી","set.battery.days":"~{{n}} દિવસ","set.demo":"ડેમો","vai.hero.title":"Chitti સાથે વાત કરો","vai.hero.cta":"બોલવા માટે ટેપ કરો.","vai.hero.hint":"Chitti તમારી ભાષામાં જવાબ આપશે.","vai.mode.ask":"કંઈ પણ પૂછો","vai-hero-sub":"લીલા માઇક ટેપ કરો.","fb.title":"Chitti — Feedback","fb.tag":"તમારો feedback Chitti ને વધુ સારી બનાવે છે","fb.back":"પાછું","fb.q":"શું થયું? કહો","fb.mic.label":"🎙️ બોલીને કહો કે નીચે લખો","fb.text.ph":"અહીં લખો — અથવા ઉપર લીલા માઇક પર ટેપ કરો.","fb.readback.who":"Chitti પૂછે છે","fb.no":"બદલો","fb.yes":"હા — મોકલો","fb.read":"વાંચીને સંભળાવો","fb.submit":"મોકલો","fb.thanks":"આભાર — feedback મળ્યો","fb.thanks.sub":"તમારી વાત Chitti ના founder સુધી પહોંચી.","na.cat.khabar":"AI ખબર","na.cat.certs":"પ્રમાણપત્ર","na.cat.topics":"કોચિંગ વિષય","na.cat.tools":"Tools","na.cat.bharat":"ભારત AI","ui.suno":"સાંભળો","ui.mool":"મૂળ ખબર વાંચો →","err.network":"Chitti sambhali nathi — pacho bolo","err.retry":"ફરી બોલો",
    },
    kn: {
      ...
      "hdr.howto":"ಹೇಗೆ ಬಳಸಬೇಕು","hdr.gp":"ಹಿರಿಯರ ಮೋಡ್","hdr.settings":"ಸೆಟ್ಟಿಂಗ್ಸ್","set.battery.title":"Chitti ಬ್ಯಾಟರಿ","set.battery.queries":"ಪ್ರಶ್ನೆಗಳು ಬಾಕಿ","set.battery.days":"~{{n}} ದಿನಗಳು","set.demo":"ಡೆಮೋ","vai.hero.title":"Chitti ಜೊತೆ ಮಾತಾಡಿ","vai.hero.cta":"ಮಾತಾಡಲು ಟ್ಯಾಪ್ ಮಾಡಿ.","vai.hero.hint":"Chitti ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಉತ್ತರಿಸುತ್ತದೆ.","vai.mode.ask":"ಏನು ಕೇಳಿ","vai-hero-sub":"ಹಸಿರು ಮೈಕ್ ಟ್ಯಾಪ್ ಮಾಡಿ.","fb.title":"Chitti — Feedback","fb.tag":"ನಿಮ್ಮ feedback Chitti-ಯನ್ನು ಉತ್ತಮಗೊಳಿಸುತ್ತದೆ","fb.back":"ಹಿಂದೆ","fb.q":"ಏನು ಆಯ್ತು? ಹೇಳಿ","fb.mic.label":"🎙️ ಹೇಳಿ ಅಥವಾ ಕೆಳಗೆ ಬರೆಯಿರಿ","fb.text.ph":"ಇಲ್ಲಿ ಬರೆಯಿರಿ — ಅಥವಾ ಮೇಲೆ ಹಸಿರು ಮೈಕ್ ಒತ್ತಿ.","fb.readback.who":"Chitti ಕೇಳುತ್ತಿದೆ","fb.no":"ಬದಲಾಯಿಸಿ","fb.yes":"ಹೌದು — ಕಳಿಸಿ","fb.read":"ಓದಿ ಹೇಳಿ","fb.submit":"ಕಳಿಸಿ","fb.thanks":"ಧನ್ಯವಾದಗಳು — feedback ಸಿಕ್ಕಿತು","fb.thanks.sub":"ನಿಮ್ಮ ಮಾತು Chitti founder ತಲುಪಿತು.","na.cat.khabar":"AI ಸುದ್ದಿ","na.cat.certs":"ಪ್ರಮಾಣಪತ್ರ","na.cat.topics":"ತರಬೇತಿ ವಿಷಯ","na.cat.tools":"Tools","na.cat.bharat":"ಭಾರತ AI","ui.suno":"ಕೇಳಿ","ui.mool":"ಮೂಲ ಸುದ್ದಿ ಓದಿ →","err.network":"Chitti keelilla — matte heli","err.retry":"ಮತ್ತೆ ಹೇಳಿ",
    },
    ml: {
      ...
      "hdr.howto":"എങ്ങനെ ഉപയോഗിക്കാം","hdr.gp":"മുതിർന്നവർ മോഡ്","hdr.settings":"ക്രമീകരണങ്ങൾ","set.battery.title":"Chitti ബാറ്ററി","set.battery.queries":"ചോദ്യങ്ങൾ ബാക്കി","set.battery.days":"~{{n}} ദിവസം","set.demo":"ഡെമോ","vai.hero.title":"Chitti യോട് സംസാരിക്കൂ","vai.hero.cta":"സംസാരിക്കാൻ ടാപ്പ് ചെയ്യൂ.","vai.hero.hint":"Chitti നിങ്ങളുടെ ഭാഷയിൽ മറുപടി പറയും.","vai.mode.ask":"എന്തും ചോദിക്കൂ","vai-hero-sub":"പച്ച മൈക്ക് ടാപ്പ് ചെയ്യൂ.","fb.title":"Chitti — Feedback","fb.tag":"നിങ്ങളുടെ feedback Chitti-യെ മെച്ചപ്പെടുത്തുന്നു","fb.back":"തിരികെ","fb.q":"എന്താ സംഭവിച്ചത്? പറയൂ","fb.mic.label":"🎙️ പറയൂ അല്ലെങ്കിൽ താഴെ എഴുതൂ","fb.text.ph":"ഇവിടെ എഴുതൂ — അല്ലെങ്കിൽ മുകളിലെ പച്ച മൈക്കിൽ ടാപ്പ് ചെയ്യൂ.","fb.readback.who":"Chitti ചോദിക്കുന്നു","fb.no":"മാറ്റൂ","fb.yes":"അതെ — അയക്കൂ","fb.read":"വായിച്ച് കേൾപ്പിക്കൂ","fb.submit":"അയക്കൂ","fb.thanks":"നന്ദി — feedback ലഭിച്ചു","fb.thanks.sub":"നിങ്ങളുടെ വാക്കുകൾ Chitti-യുടെ founder-ലേക്ക് എത്തി.","na.cat.khabar":"AI വാർത്ത","na.cat.certs":"സർട്ടിഫിക്കേഷൻ","na.cat.topics":"പരിശീലന വിഷയങ്ങൾ","na.cat.tools":"Tools","na.cat.bharat":"ഭാരത AI","ui.suno":"കേൾക്കൂ","ui.mool":"മൂല വാർത്ത വായിക്കൂ →","err.network":"Chitti ketilla — onnoode parayuu","err.retry":"വീണ്ടും പറയൂ",
    },
  };
