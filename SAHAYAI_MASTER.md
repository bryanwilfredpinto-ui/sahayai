...
| `chitti_mechanic_2w.html` | `chitti-mechanic-2w/` — full Mechanic 2W ownership OS (CEOS v1.0, 2026-06-13); engine `chitti_mechanic_2w_engine.js`; backend `chitti-mechanic-2w-api` (honest stubs). Ground-up rebuild; legacy `chitti-2wheeler/` retired 2026-06-24 — `chitti-mechanic-2w/` is canonical. |
