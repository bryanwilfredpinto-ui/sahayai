#!/usr/bin/env python3
"""Bake scripts/all_pages_translations.json into chitti_lang.js with:
...
TRANS_FILE = REPO / "scripts" / "all_pages_translations.json"
...
__T_TABLE__
  ...
  window.Chitti.lang = {
    ...
    // translateAll pass — no race between the two scripts.
...
def main() -> int:
    if not TRANS_FILE.exists():
        print("FAIL: scripts/all_pages_translations.json not found", file=sys.stderr)
        return 1
