...
for Vaani in Render. Adds a NEW redirect URI:
   ...
   default: https://chitti-vaani-api-production.up.railway.app/api/admin/products/oauth/callback
...
def _redirect_uri() -> str:
    return os.environ.get(
        "ADMIN_OAUTH_REDIRECT_URI",
        "https://chitti-vaani-api-production.up.railway.app/api/admin/products/oauth/callback",
    )
