...
Environment variables (set in Render dashboard, NOT in repo):
  ...
  GOOGLE_REDIRECT_URI   (default: https://chitti-vaani-api-production.up.railway.app/api/vaani/email/auth/callback)
"""
...
def _redirect_uri():
    return os.environ.get(
        "GOOGLE_REDIRECT_URI",
        "https://chitti-vaani-api-production.up.railway.app/api/vaani/email/auth/callback",
    )
