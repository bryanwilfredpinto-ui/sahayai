...
|---|---|---|---|
| S1 | Same as [chitti-complete-technical scope](../../chitti-complete-technical/skills/FEATURES.md) — SIP calc, FD/MF/Gold comparison, Budget impact, IPO tracker, Explain-this-term, Portfolio tracker. | P1–P2 | Backend is shared (chitti-shares-api); both pages surface the same APIs. |
