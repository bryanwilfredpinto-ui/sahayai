"""
database.py — Turso ledger + session management for chitti-voice-factory.
...
/tmp/chitti_voice_factory.db via stdlib sqlite3; sync to Turso failed with
wal_insert_begin; container restart wiped /tmp.
