...
_STREAM_KINDS = {"news", "courses", "cert", "tool", "job", "scheme", "roadmap_node", "grant", "research", "startup", "person", "channel", "free_resource"}
_AGG_KINDS    = {"cert", "tool", "job", "scheme", "roadmap_node", "grant", "research", "startup", "person", "channel", "free_resource"}
_DEFAULT_LIMIT = 20
_MAX_LIMIT = 100
