...
7. Watch the deploy log. First build takes 3–5 minutes. You're looking for:
   ...
   ```
8. Once green, open `https://chitti-shares-api.onrender.com/health` in a browser.
...
| Key | Value |
|---|---|
| `VITE_API_URL` | `https://chitti-shares-api.onrender.com` |
...
| API docs (Swagger) | https://chitti-shares-api.onrender.com/docs |
| Health check | https://chitti-shares-api.onrender.com/health |
