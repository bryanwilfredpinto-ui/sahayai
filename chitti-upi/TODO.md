...
| P0-3 | Verify on live before handover: `curl https://chitti-upi-api-production.up.railway.app/api/upi/health` and one `/check` smoke   | Project memory _Verify on live before handover_ — Bryan should never be the one who discovers it broken.  |
