...
**PASS 106 · FAIL 0.** (incl. OBD structured decoder, 31 symptoms, 54-point inspection, 12 education modules, nearest-centre) Hand-computed from the versioned rule tables. Any safety mis-classification is P0.
...
**41/41 GREEN.** Real Chromium + axe-core. 5 device screenshots (1920·1366·iPad·iPhone·Android),
